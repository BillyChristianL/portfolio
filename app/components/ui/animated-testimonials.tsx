      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
              ...
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  initial={{
                    ...
                    scale: 0.9,
                    z: -100,
                    rotate: randomRotateY(testimonial.id), // Use stable ID-based rotation
                  }}
                  animate={{
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0 lg:py-5">
            <button
              onClick={handlePrev}
              className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-transparent dark:bg-transparent border-1"
            >
